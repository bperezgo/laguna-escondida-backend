...
func (_m *MockBillRepository) GetRevenueSummary(ctx context.Context, startDate time.Time, endDate time.Time) (*dto.RevenueSummary, error) {
	...
	var r0 *dto.RevenueSummary
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, time.Time, time.Time) (*dto.RevenueSummary, error)); ok {
		return rf(ctx, startDate, endDate)
	}
	if rf, ok := ret.Get(0).(func(context.Context, time.Time, time.Time) *dto.RevenueSummary); ok {
		r0 = rf(ctx, startDate, endDate)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*dto.RevenueSummary)
		}
	}
...
// MockBillRepository_GetRevenueSummary_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetRevenueSummary'
type MockBillRepository_GetRevenueSummary_Call struct {
	*mock.Call
}
...
//   - startDate time.Time
//   - endDate time.Time
func (_e *MockBillRepository_Expecter) GetRevenueSummary(ctx interface{}, startDate interface{}, endDate interface{}) *MockBillRepository_GetRevenueSummary_Call {
	return &MockBillRepository_GetRevenueSummary_Call{Call: _e.mock.On("GetRevenueSummary", ctx, startDate, endDate)}
}

func (_c *MockBillRepository_GetRevenueSummary_Call) Run(run func(ctx context.Context, startDate time.Time, endDate time.Time)) *MockBillRepository_GetRevenueSummary_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockBillRepository_GetRevenueSummary_Call) Return(_a0 *dto.RevenueSummary, _a1 error) *MockBillRepository_GetRevenueSummary_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockBillRepository_GetRevenueSummary_Call) RunAndReturn(run func(context.Context, time.Time, time.Time) (*dto.RevenueSummary, error)) *MockBillRepository_GetRevenueSummary_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockBillRepository) SetInvoiceResult(ctx context.Context, billID string, cufe string, tascode string) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for SetInvoiceResult")
	}

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string, string) error); ok {
		r0 = rf(ctx, billID, cufe, tascode)
	} else {
		r0 = ret.Error(0)
	}
...
// MockBillRepository_SetInvoiceResult_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SetInvoiceResult'
type MockBillRepository_SetInvoiceResult_Call struct {
	*mock.Call
}

// SetInvoiceResult is a helper method to define mock.On call
//   - ctx context.Context
//   - billID string
//   - cufe string
//   - tascode string
func (_e *MockBillRepository_Expecter) SetInvoiceResult(ctx interface{}, billID interface{}, cufe interface{}, tascode interface{}) *MockBillRepository_SetInvoiceResult_Call {
	return &MockBillRepository_SetInvoiceResult_Call{Call: _e.mock.On("SetInvoiceResult", ctx, billID, cufe, tascode)}
}

func (_c *MockBillRepository_SetInvoiceResult_Call) Run(run func(ctx context.Context, billID string, cufe string, tascode string)) *MockBillRepository_SetInvoiceResult_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockBillRepository_SetInvoiceResult_Call) Return(_a0 error) *MockBillRepository_SetInvoiceResult_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockBillRepository_SetInvoiceResult_Call) RunAndReturn(run func(context.Context, string, string, string) error) *MockBillRepository_SetInvoiceResult_Call {
	_c.Call.Return(run)
	return _c
}
